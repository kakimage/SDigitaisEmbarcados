...
void lcd_gotoxy (uint8_t col, uint8_t lin)
{
    qtd = lin
}
...
void lcd_init (uint8_t RS, uint8_t RW, uint8_t E, uint8_t D0, uint8_t D1, uint8_t D2, uint8_t D3, uint8_t D4, uint8_t D5, uint8_t D6, uint8_t D7)
{
	pino_RS = RS;
	pino_RW = RW;
	pino_E  = E;
