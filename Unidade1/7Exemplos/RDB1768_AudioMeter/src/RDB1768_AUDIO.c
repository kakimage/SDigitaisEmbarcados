...
void vfAudioInit(void)
{
	...
	// Turn on I2S (exception 43-16=27) interrupts in NVIC
...
void I2S_IRQHandler(void)
{
	...
	Q31_I2S_Left = I2SRXFIFO<<8;
	Q31_I2S_Right = I2SRXFIFO<<8;
	// Convert back to 24-bit righ justified values for the codec
	I2STXFIFO = Q31_I2S_Left>>8;
	I2STXFIFO = Q31_I2S_Right>>8;
